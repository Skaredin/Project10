...
public class Main {
    public static void main(String[] args) {
        try {
            Document doc = Jsoup.connect("ht://fat.urfu.ru/").get();
            ...
            for (int i = 3; i < 20; i++) {
                if (!(i % 2 == 0)) {
                    ...
                    System.out.println("Дата " + ((Element) nodes.get(i)).getElementsByClass("blockdate").get(0).childNodes().get(0) + "\r");
